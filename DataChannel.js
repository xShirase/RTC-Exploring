/*
 2013, @muazkh Â» github.com/muaz-khan
 MIT License Â» https://webrtc-experiment.appspot.com/licence/
 Documentation Â» https://github.com/muaz-khan/WebRTC-Experiment/tree/master/DataChannel
*/
...
(function () {
    ...
    function RTCPeerConnection(options) {
        ...
        iceServers = {
            iceServers: options.iceServers || [TURN1]
        };

        if (!moz && !options.iceServers) {
            iceServers.iceServers[1] = TURN2;
        }
